...
cursor2.execute("select gtin, tail from marking.line where batch_date = '2022-12-02' "
                "and line = 'A1-13' and cod_gp = '31220' and verified_status='verified'")
data2 = cursor2.fetchall()

conn = psycopg2.connect(dbname='molzavod', user='postgres', password='111111', host='192.168.240.5')
cursor = conn.cursor()

cursor.execute("select gtin, tail from marking.line where batch_date = '2022-12-02' "
               "and line = 'A1-13' and cod_gp = '31220' and verified_status='verified'")
